...
class RichTestResult:
    ...
    def matches(self, expecting: Any) -> bool:
        ...
        for ann in cast("list[dict[str, Any]]", expecting):
            loc = cast("str", ann.get("instanceLocation", ""))
            kw = cast("str", ann.get("keyword", ""))
            kw_loc = cast("str", ann.get("keywordLocation", ""))
            ...
            expected_annotations[loc][kw][decoded_kw_loc] = annotation
