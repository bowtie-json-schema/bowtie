          ...
          <thead>
            <tr>
              ...
              Bowtie is tool for understanding and comparing implementations of the &nbsp; 
               <a href={"https://json-schema.org/"} target={"_blank"} rel={"noreferrer"}>{"JSON Schema specification"}</a>  &nbsp;
               across all programming languages. 
              The report below uses the &nbsp;
              <a href={"https://github.com/json-schema-org/JSON-Schema-Test-Suite"} target={"_blank"} rel={"noreferrer"}>{"official JSON Schema Test Suite"}</a> &nbsp; 
              ...
              You can find out how in its &nbsp;
              <a href={"https://docs.bowtie.report/"} target={"_blank"} rel={"noreferrer"}>{"documentation"}</a>.
              </td>
            </tr>
          </thead>
        </table>
