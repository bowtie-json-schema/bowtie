...
const BenchmarkRunInfoSection = ({ benchmarkRunMetadata }: { benchmarkRunMetadata: BenchmarkRunMetadata }) => {
    return (
        <div className="card mx-auto mb-3" id="run-info">
            ...
            <div className="card-body table-responsive-sm">
                ...
                <Table size="sm" hover>
                    ...
                    <thead>
                        {benchmarkRunMetadata.systemMetadata.cpuCount && <tr>
                            <td className="align-top col-md-2">CPU Count</td>
                            <td>{benchmarkRunMetadata.systemMetadata.cpuCount.toString()}</td>
                        </tr>}
                        {benchmarkRunMetadata.systemMetadata.cpuFreq && <tr>
                            <td className="align-top col-md-2">CPU Frequency</td>
                            <td>{benchmarkRunMetadata.systemMetadata.cpuFreq.toString()}</td>
                        </tr>}
                        {benchmarkRunMetadata.systemMetadata.cpuModel && <tr>
                            <td className="align-top col-md-2">CPU Model</td>
                            <td>{benchmarkRunMetadata.systemMetadata.cpuModel.toString()}</td>
                        </tr>}
                        <tr>
