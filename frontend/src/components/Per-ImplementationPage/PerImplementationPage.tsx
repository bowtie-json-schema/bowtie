                    ...
                    <Card.Body>
                        <Table striped bordered size="sm">
                            <tbody>
                                ...
                                <tr>
                                    <th>Language</th>
                                    <td>{implementationDetails.language}<span className="text-muted">{` (${implementationDetails.version})`}</span></td>
                                </tr>
                                <tr>
                                    <th>Dialects</th>
                                    <td>
                                        <ul>
                                            {implementationDetails.dialects.map((dialect, index) => (
                                                <li key={index}><Link to={dialect}>{dialect}</Link></li>
                                            ))}
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Image</th>
                                    <td><Link to={implementationDetails.image}>{implementationDetails.image}</Link></td>
                                </tr>
                                <tr>
                                    <th>Homepage</th>
                                    <td><Link to={implementationDetails.homepage}>{implementationDetails.homepage}</Link></td>
                                </tr>
                                <tr>
                                    <th>Issues</th>
                                    <td><Link to={implementationDetails.issues}>{implementationDetails.issues}</Link></td>
                                </tr>
                            </tbody>
                        </Table>
                    </Card.Body>
