...
describe("Badge", () => {
  test("versionsBadgeFor should return the correct URL", () => {
    ...
    expect(badgeUrl.href).toEqual(
      "https://img.shields.io/endpoint?url=http%3A%2F%2Flocalhost%3A3000%2F%2Fbadges%2Fjavascript-node%2Fsupported_versions.json"
    );
  });
  ...
  test("complianceBadgeFor should return the correct URL", () => {
    ...
    expect(badgeURL.href).toEqual(
      "https://img.shields.io/endpoint?url=http%3A%2F%2Flocalhost%3A3000%2F%2Fbadges%2Fjavascript-node%2Fcompliance%2Fdraft7.json"
    );
  });
});
