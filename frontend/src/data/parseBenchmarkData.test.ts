...
describe("parseBenchmarkReportData", () => {
    test("parses benchmark reports", async () => {
                    ...
                    benchmarkResults: [
                        {
                            ...
                            testResults:[
                                {
                                    description: "test 1",
                                    implementationResults: reportResults[0].benchmarkResults[0].testResults[0].implementationResults
                                },
                                {
                                    description: "test 2",
                                    implementationResults: reportResults[0].benchmarkResults[0].testResults[1].implementationResults
                                }
                            ]
                        }
                    ],
